...
"aarch64\-linux\-thread\-multi-6\.11\.0" or
	die "Errno architecture (aarch64\-linux\-thread\-multi-6\.11\.0) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
